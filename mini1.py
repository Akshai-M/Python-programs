        ...
        with open(file_path, 'r') as file:
            for line in file:
                ...
                if len(student_data) == 2:
                    student = Student(student_data[0], int(student_data[1]), float(student_data[2]))
...
def display_student_details(student_list, student_id):
...
def display_due_fees(student_list, student_id):
    for student in student_list:
        if student.student_id == student_id:
...
while True:
    ...
    if choice == 1:
        ...
        student_id = (input("Enter student ID to update fees: "))
        display_student_details(students, student_id)

    elif choice == 4:
        student_id = (input("Enter student ID to update fees: "))
        display_due_fees(students, student_id)
